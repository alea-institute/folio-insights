...
<div class="app-shell">
	<header class="header">
		...
		{:else if activePage === 'tasks'}
			...
			<div class="header-right">
				<button class="settings-btn" aria-label="Task summary dashboard" title="Task summary dashboard" onclick={() => { window.dispatchEvent(new CustomEvent('toggle-task-dashboard')); }}>
					<svg
						width="18"
						height="18"
						viewBox="0 0 24 24"
